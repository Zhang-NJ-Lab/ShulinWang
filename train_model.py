...
def model_load(IMG_SHAPE=(224, 224, 3), is_transfer=False):
    ...
    if is_transfer:
        ...
        model = tf.keras.models.Sequential([
            tf.keras.layers.experimental.preprocessing.Rescaling(1. / 255, input_shape=(1324, 528,3)),
...
def train(epochs, is_transfer=False):
    ...
    train_ds, val_ds, class_names = data_load("data/traindata", 1324, 528, 2)
    ...
    if is_transfer:
        ...
        model.save("models/t_mymodel.h5")
    else:
